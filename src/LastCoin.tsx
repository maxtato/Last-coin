...
const luck = () => 1;
// Slot machine classique : chaque gain paie EXACTEMENT mise x multiplicateur,
// pas de scaling selon la fortune. cashScale reste comme fonction pour eviter
// de reecrire les appels, mais retourne toujours 1.
const cashScale = () => 1;
